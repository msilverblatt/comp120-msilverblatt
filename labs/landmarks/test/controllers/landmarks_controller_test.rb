...
class LandmarksControllerTest < ActionController::TestCase
  ...
  test "should create landmark" do
    assert_difference('Landmark.count') do
      post :create, landmark: { info: @landmark.info, lat: @landmark.lat, lng: @landmark.lng, name: @landmark.name }
    end
  ...
  test "should update landmark" do
    patch :update, id: @landmark, landmark: { info: @landmark.info, lat: @landmark.lat, lng: @landmark.lng, name: @landmark.name }
    assert_redirected_to landmark_path(assigns(:landmark))
  end
